...
export function CompactNavigation() {
  ...
  return <nav className="workspace-bottom-nav" aria-label="主导航">
    ...
    <M3NavigationItem className="workspace-bottom-nav__item" selected={route.kind === "hub"} onClick={() => navigate({ kind: "hub", hubId: "primary" })}><Icon name="hub" size={18} /><span>连接</span></M3NavigationItem>
